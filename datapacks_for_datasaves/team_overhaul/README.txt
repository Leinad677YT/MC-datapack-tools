# IMPORTANT
  ...
  · This datapack requires players to have the score "player_id" as a numeric ID in order to assign serverside teams
...
# DEPENDENCIES
  ...
  · NEEDED:
    > player id assigner
      · Required for players to have the score "player_id" as a numeric ID in order to assign serverside teams  
